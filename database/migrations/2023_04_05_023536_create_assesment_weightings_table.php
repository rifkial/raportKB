...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('assesment_weightings', function (Blueprint $table) {
    ...
    {
        Schema::table('assesment_weightings', function (Blueprint $table) {
            $table->dropForeign('assesment_weightings_id_course_foreign');
            $table->dropForeign('assesment_weightings_id_study_class_foreign');
            $table->dropForeign('assesment_weightings_id_teacher_foreign');
            $table->dropForeign('assesment_weightings_id_school_year_foreign');
        });
