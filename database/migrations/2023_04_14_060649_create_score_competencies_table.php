...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('score_competencies', function (Blueprint $table) {
    ...
    {
        Schema::table('score_competencies', function (Blueprint $table) {
            $table->dropForeign('score_competencies_id_student_class_foreign');
            $table->dropForeign('score_competencies_id_teacher_foreign');
            $table->dropForeign('score_competencies_id_course_foreign');
            $table->dropForeign('score_competencies_id_study_class_foreign');
            $table->dropForeign('score_competencies_id_school_year_foreign');
        });
