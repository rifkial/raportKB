...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('score_manuals', function (Blueprint $table) {
    ...
    {
        Schema::table('score_manuals', function (Blueprint $table) {
            $table->dropForeign('score_manuals_id_student_class_foreign');
            $table->dropForeign('score_manuals_id_teacher_foreign');
            $table->dropForeign('score_manuals_id_course_foreign');
            $table->dropForeign('score_manuals_id_study_class_foreign');
            $table->dropForeign('score_manuals_id_school_year_foreign');
        });
