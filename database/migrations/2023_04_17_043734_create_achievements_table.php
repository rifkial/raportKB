...
return new class extends Migration
{
    ...
    {
        Schema::table('achievements', function (Blueprint $table) {
            $table->dropForeign('achievements_id_student_class_foreign');
            $table->dropForeign('achievements_id_teacher_foreign');
            $table->dropForeign('achievements_id_study_class_foreign');
            $table->dropForeign('achievements_id_school_year_foreign');
        });
