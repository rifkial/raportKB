...
class BasicCompetencySheet implements FromView, WithStyles, ShouldAutoSize
{
    public function view(): View
    {
        return view('export.v_ex_basic_competency');
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->mergeCells('A6:M6')->setCellValue('A6', "4. Isi Kode Mapel bisa dilihat pada Sheet Mata Pelajaran.");
        $sheet->mergeCells('A7:M7')->setCellValue('A7', "5. Isi Kode Tingkat bisa dilihat pada Sheet Tingkat.");
        $sheet->mergeCells('A8:M8')->setCellValue('A8', "6. Pastikan Kode Mapel, Kode Tingkat terdaftar pada sekolah.");
        ...
        $sheet->getStyle('D11')->getFont()->setBold(true)->getColor()->setARGB('99004C');
